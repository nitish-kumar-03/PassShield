      ...
      <section className="min-h-screen w-full bg-gray-200 p-5 sm:p-3 ">
        <div className="flex justify-between items-center gap-2  px-2">
          <h1 className="text-xl">
            <span className="text-red-600">Important Note :</span> Store Your
            important password for your important accounts{" "}
          </h1>

          <button
            onClick={HanldeLogut}
            className="p-1 px-2 bg-red-600  rounded-md text-white font-semibold "
          >
            Logout
          </button>
        </div>
        ...
        <form
          ...
          action=""
          className="   w-full lg:w-1/2 mx-auto lg:transition-transform duration-200 mt-5 ease-in-out lg:hover:scale-105 bg-yellow-400 flex gap-2 flex-col p-5 rounded-sm shadow-sm"
        >
          ...
          <button className="p-2 rounded-md  transition-transform duration-200 ease-in-out hover:scale-105 bg-red-600 text-white font-semibold w-full  sm:w-1/4 mx-auto mt-3">
            Add Password
          </button>
        </form>
