...
const Passworditem = ({ value }) => {
  ...
  const [updatepwd, setupdatepwd] = useState({ id: "", bol: false });
    ...
    <>
      <div className="flex flex-col gap-3 transition-transform hover:scale-95 duration-150 ease-in bg-white p-5 rounded-md shadow-sm">
        <input
          ...
          disabled={!updatepwd?.bol}
          onChange={(e) => setnewpwddata({ ...newpwddata, title: e.target.value })}
        ...
        <div className="w-full relative">
          <input
            ...
            onChange={(e) => setnewpwddata({ ...newpwddata, password: e.target.value })}
        ...
        {updatepwd?.bol ? (
          <div className="flex items-center justify-end gap-2">
            <button
              ...
              onClick={() => setupdatepwd({ id: "", bol: false })}
            >
              Cancel
            </button>
            <button
          ...
          <div className="flex items-center justify-end gap-1">
            ...
            <button
              onClick={() => setupdatepwd({ bol: !updatepwd?.bol, id: value?._id })}
